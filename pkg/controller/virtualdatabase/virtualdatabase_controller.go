...
var log = logf.Log.WithName("controller_virtualdatabase")
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileVirtualDatabase{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &teiidv1alpha1.VirtualDatabase{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileVirtualDatabase) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling VirtualDatabase")
