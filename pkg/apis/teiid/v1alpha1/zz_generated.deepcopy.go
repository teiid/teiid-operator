...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExposeObject) DeepCopyInto(out *ExposeObject) {
	*out = *in
	if in.Types != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExposeObject.
func (in *ExposeObject) DeepCopy() *ExposeObject {
	if in == nil {
		return nil
	}
	out := new(ExposeObject)
	in.DeepCopyInto(out)
	return out
}
