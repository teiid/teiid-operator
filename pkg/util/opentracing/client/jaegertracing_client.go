...
func NewForConfig(c *rest.Config) (*JaegertracingV1Client, error) {
	...
	return &JaegertracingV1Client{client}, nil
}

// NewForConfigOrDie creates a new JaegertracingV1Client for the given config and
...
func New(c rest.Interface) *JaegertracingV1Client {
	return &JaegertracingV1Client{c}
}
